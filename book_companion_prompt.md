...
**Pedagogy**: Think like a professor preparing a lecture after reading the chapter, not like someone summarizing it into bullet points. Teach the concepts in a sensible order, with clarity as the priority. The content should capture the essence that is useful.
